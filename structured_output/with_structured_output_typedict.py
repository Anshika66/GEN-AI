...
#annotated is used to add a line about what you have expected
...
bloatware-why do I need
five different Samsung apps for things Google already provides? The $1,300 price tag is also a hard
pill to swallow.
Pros:
...
Cons:
Bulky
and heavy-not great for one-handed use
